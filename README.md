...
The official Omada Controller v6.x Docker images (including [mbentley/omada-controller](https://github.com/mbentley/docker-omada-controller)) ship with MongoDB 8.x, which requires AVX CPU instructions. This means older CPUs (pre-2011 Intel, pre-2011 AMD) cannot run MongoDB 8.x and therefore cannot run Omada Controller v6.x.
